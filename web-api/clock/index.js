const faceColor = document.getElementById('face-color'),
	...
	largeHandColor = document.getElementById('large-hand-color'),
	secondHandColor = document.getElementById('second-hand-color'),
...
function clock() {
	...
	localStorage.setItem('colors', JSON.stringify([faceColor.value, borderColor.value]));
